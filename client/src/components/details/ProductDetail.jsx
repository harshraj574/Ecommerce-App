    ...
    return (
      <>
       <Typography>{product.title.longTitle}</Typography>
            ...
            <SmallText>
                <Typography><StyledBadge/>Get ₹50 instant discount on first Flipkart UPI txn on order of ₹200 and above T&C</Typography>
                <Typography><StyledBadge/>Get extra 47% off (price inclusive of cashback/coupon) T&C</Typography>
                <Typography><StyledBadge/>Sign-up for Flipkart Pay Later & get free Times Prime Benefits worth ₹20,000*Know More</Typography>
                <Typography><StyledBadge/>Buy 2 items save 5%; Buy 3 or more save 7%See all products T&C</Typography>
                <Typography><StyledBadge/>5% Cashback on Flipkart Axis Bank Card T&C</Typography>
                <Typography><StyledBadge/>10% off up to ₹1,500 on HDFC Bank Credit Card EMI Txns, Tenure: 12 months, Min Txn Value: ₹7500 T&C</Typography>
            </SmallText>
            <Table>
                <TableBody>
                    <ColumnText>
